...
public class MenuOptionExecuter {
    public func executePrimaryExample() {
        ...
        print("-> .undirected, from: two, to: three, weight: 3")
    ...
    public func executeTests() {
        ...
        primTests.testIfMethodReturnsUpdatedSetForNewVertex()
        primTests.testIfMethodAddsUnvisitedEdgeToQueue()
        primTests.testIfMethodGeneratesCorrectMST()
        
        let priorityQueueTests = PriorityQueueTests()
        priorityQueueTests.testIsEmptyReturnsTrueIfThereIsNoElementsInTheQueue()
        priorityQueueTests.testIsEmptyReturnsFalseIfThereIsNoElementsInTheQueue()
        priorityQueueTests.testCountReturnsNumberOfElementsInQueue()
